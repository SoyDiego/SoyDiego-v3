...
const Header = () => {
	return (
		<div
			...
			<div className="tw-relative md:tw-h-screen tw-grid tw-place-content-center tw-z-10">
				<div className="tw-text-center tw-py-4">
					<h1 className="tw-text-5xl tw-font-bold tw-pb-3">
				...
				<div className="info tw-py-4">
					<div className="tw-flex tw-justify-around">
						<p className="tw-text-white tw-font-bold">Barcelona, España</p>
						<p className="tw-text-white tw-font-bold">+34 644 464 398</p>
					</div>
				</div>
